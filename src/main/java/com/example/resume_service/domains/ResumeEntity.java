...
public class ResumeEntity extends Auditable {
    ...
    public ResumeEntity(Timestamp createdAt, Timestamp updatedAt, Long createdBy, Long updatedBy, boolean deleted, Long id, String name, String surname, String phone, String city, LocalDate dateOfBirth, Floor floor, List<CountryEntity> citizenship, boolean workExperience, String career, Integer salary, CurrencyType currencyType, ExperienceEntity education, Level level, List<LanguageSkillsEntity> languageSkills) {
